...
import '../modules/add_participant/bindings/add_participant_binding.dart';
import '../modules/add_participant/views/add_participant_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.ADD_PARTICIPANT,
      page: () => const AddParticipantView(),
      binding: AddParticipantBinding(),
      transition: Transition.fadeIn,
    ),
    GetPage(
      name: _Paths.LOGIN,
